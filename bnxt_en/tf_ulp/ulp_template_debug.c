...
const char *ulp_mapper_resource_func_names[] = {
	...
	[BNXT_ULP_RESOURCE_FUNC_RSVD1] = "RSVD1 Table",
	[BNXT_ULP_RESOURCE_FUNC_RSVD2] = "RSVD2 Table",
...
void ulp_parser_hdr_info_dump(struct ulp_tc_parser_params *params)
{
	...
	if (ULP_BITMAP_ISSET(hdr_bitmap->bits,
...
{
	struct ulp_tc_act_bitmap *act_bitmap = &params->act_bitmap;
