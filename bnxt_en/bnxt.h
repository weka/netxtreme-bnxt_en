...
#define DRV_MODULE_VERSION	"1.10.2" DRV_MODULE_EXTRA_VER
...
#define TX_OPAQUE_IDX_MASK	0x00ffffff
#define TX_OPAQUE_RING_MASK	0xff000000
#define TX_OPAQUE_RING_SHIFT	24

#define SET_TX_OPAQUE(txr, idx)					\
	(((txr)->tx_napi_idx << TX_OPAQUE_RING_SHIFT) | (idx))
...
struct rx_cmp_ext {
	...
	#define RX_CMP_FLAGS2_L4_CS_OK_MASK			(0x7 << 13)
...
#define RX_CMP_V2_L4_CS_OK_CNT(rxcmp1)					\
	(RX_CMP_V2_L4_CS_OK(rxcmp1) >> RX_CMP_FLAGS2_L4_CS_OK_SFT)
...
struct rx_tpa_start_cmp_ext {
	...
	#define RX_TPA_START_CMP_FLAGS2_L4_CS_OK_MASK		(0x7 << 13)
	 #define RX_TPA_START_CMP_FLAGS2_L4_CS_OK_SFT		 13
...
#define TPA_START_V2_L4_CS_OK_CNT(flags2)				\
	(((flags2) & RX_TPA_START_CMP_FLAGS2_L4_CS_OK_MASK) >>		\
	 RX_TPA_START_CMP_FLAGS2_L4_CS_OK_SFT)
...
#define BNXT_VPD_FLD_LEN	32
	...
	#define BNXT_FLAG_CHIP_P5_THOR2	0x80000
	#define BNXT_FLAG_MULTI_HOST	0x100000
	#define BNXT_FLAG_DSN_VALID	0x200000
	#define BNXT_FLAG_DOUBLE_DB	0x400000
	#define BNXT_FLAG_RX_CMPL_V2	0x800000
...
#define BNXT_CHIP_SUPPORTS_PHY(bp)	(BNXT_ASIC(bp) || BNXT_CHIP_P5_THOR2(bp))
...
#define BNXT_NUM_TPA_RING_STATS_P5_THOR2	6
...
#define BNXT_RING_STATS_SIZE_P5_THOR2				\
	((BNXT_NUM_RX_RING_STATS + BNXT_NUM_TX_RING_STATS +	\
	  BNXT_NUM_TPA_RING_STATS_P5_THOR2) * 8)
...
int bnxt_hwrm_vnic_alloc(struct bnxt *bp, u16 vnic_id, unsigned int start_rx_ring_idx,
